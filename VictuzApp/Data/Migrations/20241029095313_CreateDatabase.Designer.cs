...
namespace VictuzApp.Data.Migrations
{
    ...
    [Migration("20241029095313_CreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VictuzApp.Models.Participant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VictuzApp.Models.Administrator", b =>
                {
                    b.HasBaseType("VictuzApp.Models.Participant");
            ...
            modelBuilder.Entity("VictuzApp.Models.BoardMember", b =>
                {
                    b.HasBaseType("VictuzApp.Models.Participant");
            ...
            modelBuilder.Entity("EventParticipant", b =>
                {
                    b.HasOne("VictuzApp.Models.Event", null)
                        .WithMany()
                        .HasForeignKey("EventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VictuzApp.Models.Participant", null)
                        .WithMany()
